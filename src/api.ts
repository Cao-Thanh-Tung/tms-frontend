...
export const SearchResourceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        searchByRange: async (entityName: string, attributeName: string, startValue: number, endValue: number, pageable: Pageable, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'entityName' is not null or undefined
            assertParamExists('searchByRange', 'entityName', entityName)
            // verify required parameter 'attributeName' is not null or undefined
            assertParamExists('searchByRange', 'attributeName', attributeName)
            // verify required parameter 'startValue' is not null or undefined
            assertParamExists('searchByRange', 'startValue', startValue)
            // verify required parameter 'endValue' is not null or undefined
            assertParamExists('searchByRange', 'endValue', endValue)
            // verify required parameter 'pageable' is not null or undefined
...
export const SearchResourceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async searchByRange(entityName: string, attributeName: string, startValue: number, endValue: number, pageable: Pageable, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<object>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.searchByRange(entityName, attributeName, startValue, endValue, pageable, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const SearchResourceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        searchByRange(entityName: string, attributeName: string, startValue: number, endValue: number, pageable: Pageable, options?: any): AxiosPromise<Array<object>> {
            return localVarFp.searchByRange(entityName, attributeName, startValue, endValue, pageable, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} entityName 
...
export class SearchResourceApi extends BaseAPI {
     ...
     * @memberof SearchResourceApi
     */
    public searchByRange(entityName: string, attributeName: string, startValue: number, endValue: number, pageable: Pageable, options?: RawAxiosRequestConfig) {
        return SearchResourceApiFp(this.configuration).searchByRange(entityName, attributeName, startValue, endValue, pageable, options).then((request) => request(this.axios, this.basePath));
    }
