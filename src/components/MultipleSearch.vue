<template>
  <div>
    ...
    >
      ...
      <a-input v-model:value="criterion.value" class="criterion-input" />
    ...
    <div class="criterion">
      ...
      />
      <a-date-picker
        v-else-if="getSelectedFieldType(selectedField || 'unknown') === 'date'"
        v-model:value="searchValue"
        class="criterion-input"
      />

      <a-button @click="addCriterion" class="add-button"
